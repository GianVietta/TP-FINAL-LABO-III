...
public class ListaProfesores {
    private JPanel listaProfesoresPanel;

    public ListaProfesores(Object data[][], String columnName[]) throws HeadlessException {
        ListaProfesores.NonEditableTableModel model = new ListaProfesores.NonEditableTableModel(data, columnName);
