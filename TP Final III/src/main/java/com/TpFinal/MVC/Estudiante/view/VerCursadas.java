...
public class VerCursadas {
    private JPanel panelCursadas;

    public VerCursadas(Object data[][], String columnName[]) throws HeadlessException {

        VerCursadas.NonEditableTableModel model = new VerCursadas.NonEditableTableModel(data,columnName);
