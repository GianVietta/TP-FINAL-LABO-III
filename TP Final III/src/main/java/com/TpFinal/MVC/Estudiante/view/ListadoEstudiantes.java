...
public class ListadoEstudiantes extends JFrame {
    ...
    private JPanel listarEstPanel;

    public ListadoEstudiantes(Object data[][], String columnName[]) throws HeadlessException {
       ...
       btnVolver.setForeground(Color.white);
        ...
        listarEstPanel.setBackground(new Color(59,59,59));
        jFrame.add(listarEstPanel);
        listarEstPanel.setBackground(new Color(70, 72, 75));
